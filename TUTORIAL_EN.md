...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/qusuo/leaf/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://github.com/qusuo/leafserver)) which all share below traits:

* Each module runs inside a separate goroutine
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/qusuo/leaf/tree/master/chanrpc))
...
[LeafServer](https://github.com/qusuo/leafserver) is a game server developped with Leaf. Let's start with it.

Download the source code of LeafServer：

```
git clone https://github.com/qusuo/leafserver
```

Download and install leafserver to GOPATH:

```
go get github.com/qusuo/leaf
```
...
import (
    "github.com/qusuo/leaf/network/json"
)
...
More references are at [leaf/go](https://github.com/qusuo/leaf/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/qusuo/leaf/blob/master/timer)。
...
More references are at [leaf/log](https://github.com/qusuo/leaf/blob/master/log).

### Leaf recordfile

Leaf recordfile is formatted in CSV([Example](https://github.com/qusuo/leaf/blob/master/recordfile/test.txt)). recordfile is to manage the configuration for game. The usage of recordfile in LeafServer is quite simple:
...
Refer to [leaf/recordfile](https://github.com/qusuo/leaf/blob/master/recordfile) for more details.

Learn more
----------

More references are at Wiki [https://github.com/qusuo/leaf/wiki](https://github.com/qusuo/leaf/wiki)
